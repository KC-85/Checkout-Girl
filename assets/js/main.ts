...
document.querySelector<HTMLButtonElement>('[data-notify]')?.addEventListener('click', () => {
  if (statusMessage) statusMessage.textContent = 'Mailing-list link coming soon — check back for the next drop.';
});
